...
function Pnl({ t, pl }) {
  ...
  return (
    <span style={{ fontFamily: FONTS.serif, fontSize: 18, fontWeight: 500, color, letterSpacing: -0.3 }}>
      {txt}
    </span>
  );
}
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 18, fontSize: 13, color: t.ink2 }}>
          <span style={{ fontStyle: 'italic', fontFamily: FONTS.serif, whiteSpace: 'nowrap' }}>
            {subtitle}
          </span>
      ...
      {trades.length === 0 ? (
        <div style={{
          ...
          fontFamily: FONTS.serif, fontStyle: 'italic', fontSize: 18, color: t.ink3,
        }}>
    ...
    <div style={{ borderTop: `1px solid ${t.rule}` }}>
      {trades.map((tr) => (
        <button key={tr.id} onClick={() => onNavigate('detail', tr.id)}
          ...
          <span style={{ fontFamily: FONTS.serif, fontStyle: 'italic', color: t.ink3, fontSize: 13 }}>
            #{tr.id}
          </span>
